...
const MenuModal = ({ visible, onClose, onDelete, onChange, position }) => {
  return (
    <Modal
      transparent={true}
      animationType="fade"
    ...
    >
      <TouchableOpacity style={menuStyles.overlay} onPress={onClose}>
        <View style={[menuStyles.menu, { top: position.y, left: position.x }]}>
    ...
    <View style={styles.viewListForm}>
      ...
      {imageUri && (
        <View style={styles.imageContainer}>
          ...
          <TouchableOpacity style={styles.menuButton} onPress={(event) => toggleMenu(event)}>
